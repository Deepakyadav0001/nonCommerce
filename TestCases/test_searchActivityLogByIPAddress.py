...
class Test_016_searchActivityLogByIPAddress:
    baseUrl=Readconfig.getApplicationURL()
    username=Readconfig.getUsername()
    password=Readconfig.getPassword()
    logger=LogGen.loggen()

    def test_searchActivityLogByIPAddress(self):
        self.logger.info("****** Test_016_searchActivityLogByIPAddress ******")
        # To Open Browser
        ...
        self.logger.info("******* Starting Search ActivityLog By IP Address Test *******")
        ...
        # Printing All Activity Log of ip Address
        try:
            ActivityLog = self.driver.find_elements(By.XPATH, "//table[@id='activityLog-grid']/tbody/tr/td")
            for Acty in ActivityLog:
                print(Acty.text," ")
        except:
            return None
        ...
        self.logger.info("******** search ActivityLog By IPAddress Test Passed********")
        self.logger.info("********* Ending search ActivityLog By IPAddress Test *********")
