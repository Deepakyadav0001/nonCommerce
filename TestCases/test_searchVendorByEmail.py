...
class Test_014_searchVendorByEmail:
    baseUrl=Readconfig.getApplicationURL()
    username=Readconfig.getUsername()
    password=Readconfig.getPassword()
    logger=LogGen.loggen()

    def test_searchVendorByemail(self):
        self.logger.info("****** Test_014_searchVendorByEmail ******")
        # To Open Browser
        ...
        self.logger.info("******* Starting Search Vendor By Email Test *******")
        ...
        VendorEmail=self.driver.find_element(By.XPATH,"//table[@id='vendors-grid']/tbody/tr[1]/td[2]")
        if VendorEmail.text=="vendor2email@gmail.com":
            self.logger.info("******** Search Vendor By Email Test Successfully Passed ********")

        self.logger.info("******* Ending Search Vendor By Email Test")
