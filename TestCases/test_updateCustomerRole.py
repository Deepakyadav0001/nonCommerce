...
class Test_009_updateCustomerRole:
    baseUrl=Readconfig.getApplicationURL()
    username=Readconfig.getUsername()
    password=Readconfig.getPassword()
    logger=LogGen.loggen()

    def test_updateCustomerRole(self):
        self.logger.info("****** Test_009_updateCustomerRole ******")
        # To Open Browser
        ...
        self.logger.info("******* Starting Update Customer Role Test *******")
        ...
        self.logger.info("******** Customer Role Successfully Updated *********")

        self.logger.info("******* Ending Update Customer Role Test *******")
