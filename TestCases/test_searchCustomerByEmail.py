...
class Test_004_searchCustomerByEmail:
    ...
    def test_searchCustomerByEmail(self):
        ...
        for r in range(1,len(rows)):
            Email= self.driver.find_elements(By.XPATH,"//table[@id='customers-grid']/tbody/tr[" + str(r) + "]/td[2]").text

            if Email=="	victoria_victoria@nopCommerce.com":
                print("Test Passed")
        ...
        self.logger.info("******** Test Case Search Customer By Email id finished ********")
